...
void rk_run_elementwise(rk_device& dev, rk_ew_op op, 
    ...
    while (processed < size) {
        ...
        emit_raw(q, 4096, 0x4020, chunk_dst);        // REG_DPU_DST_BASE_ADDR
        ...
        emit_raw(q, 8192, 0x5018, chunk_src1);        // REG_DPU_RDMA_RDMA_SRC_BASE_ADDR
        emit_raw(q, 8192, 0x5038, chunk_src2);        // REG_DPU_RDMA_RDMA_EW_BASE_ADDR
